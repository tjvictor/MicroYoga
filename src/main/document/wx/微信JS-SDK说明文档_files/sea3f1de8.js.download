...
base:t,
map:[function(t){
var a=n(t),o=e.data.base,c=t.substr(o.length);
if("undefined"!=typeof MODULES&&MODULES[c]){
var m=MODULES[c],r=m;
return 0==r.indexOf("http://")||0==r.indexOf("https://")?r:(-1==r.indexOf(o.replace("/c/=",""))&&(r=o+m),
".js"!=a&&".css"!=a&&(r=r.replace("/c/=","")),r);
}
return o.replace("/c/=","")+i[a]+c+"?v="+s;
}]
});
}(seajs);;